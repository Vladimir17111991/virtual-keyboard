...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _js_createDOM__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/createDOM */ \"./js/createDOM.js\");\n/* harmony import */ var _js_Keyboard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/Keyboard */ \"./js/Keyboard.js\");\n/* harmony import */ var _styles_style_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./styles/style.css */ \"./styles/style.css\");\n\n\n // import './styles/style.scss';\n\nvar keyboard = new _js_Keyboard__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\nvar section = (0,_js_createDOM__WEBPACK_IMPORTED_MODULE_0__.createDom)('section', '', 'main', 'container');\nvar textArea = (0,_js_createDOM__WEBPACK_IMPORTED_MODULE_0__.createDom)('textarea', '', 'main__textarea');\nvar titleLang = (0,_js_createDOM__WEBPACK_IMPORTED_MODULE_0__.createDom)('div', 'Изменить язык ввода: Alt + Shift', 'main__language');\nvar _document = document,\n    body = _document.body;\nbody.append(section);\n\nwindow.onload = function () {\n  section.append(textArea);\n  section.append(titleLang);\n  section.append(keyboard.createKeyboard()); // pressButton();\n  // for mouse\n\n  var mouse = document.querySelector('.main__keyboard');\n  mouse.addEventListener('click', function (e) {\n    if (e.target.closest('.keyboard-key')) {\n      var btn = e.target.closest('.keyboard-key');\n\n      if (btn.dataset.code === 'ShiftLeft' || btn.dataset.code === 'ShiftRight') {\n        keyboard.pressShift = !keyboard.pressShift;\n        btn.classList.toggle('active');\n      }\n\n      pressButton(e, btn, btn.dataset.code);\n    }\n  }); //for keyboard\n\n  document.addEventListener('keydown', function (e) {\n    var btn = document.querySelector(\"[data-code=\".concat(e.code, \"]\"));\n\n    if (btn) {\n      btn.classList.toggle('active');\n      pressButton(e, btn, e.code);\n\n      if (e.code === 'CapsLock') {\n        keyboard.caseKeyboard(e);\n      }\n\n      body.classList.remove('active');\n    }\n  });\n  document.addEventListener('keyup', function (e) {\n    var btn = document.querySelector(\"[data-code=\".concat(e.code, \"]\"));\n\n    if (btn) {\n      if (e.code === 'ShiftLeft' || e.code === 'ShiftRight') {\n        btn.classList.remove('active');\n        keyboard.caseKeyboard(e); //delete uppercase \n\n        if (keyboard.pressShift) {\n          keyboard.pressShift = !keyboard.pressShift;\n          document.querySelector('.leftshift').classList.remove('active');\n          document.querySelector('.rightshift').classList.remove('active');\n        }\n      }\n    }\n  });\n};\n\nvar pressButton = function pressButton(e, btn, code) {\n  e.preventDefault();\n  textArea.focus();\n  var text = '';\n  var cursor = textArea.selectionStart;\n\n  switch (code) {\n    case 'Backspace':\n      {\n        textArea.value = textArea.value.substring(0, cursor - 1);\n        break;\n      }\n\n    case 'Space':\n      {\n        text = ' ';\n        break;\n      }\n\n    case 'Tab':\n      {\n        text = '    ';\n        break;\n      }\n\n    case 'Enter':\n      {\n        text = '\\n';\n        break;\n      }\n\n    case 'CapsLock':\n      {\n        keyboard.capsLockPress(e);\n        textArea.classList.remove('active');\n        break;\n      }\n\n    case 'ShiftLeft':\n      {\n        keyboard.caseKeyboard(e);\n        break;\n      }\n\n    case 'ShiftRight':\n      {\n        keyboard.caseKeyboard(e);\n        break;\n      }\n\n    case 'ArrowRight':\n      {\n        textArea.setSelectionRange(cursor + 1, cursor + 1);\n        break;\n      }\n\n    case 'ArrowLeft':\n      {\n        if (cursor > 0) {\n          textArea.setSelectionRange(cursor - 1, cursor - 1);\n        }\n\n        break;\n      }\n\n    case 'ArrowUp':\n      {\n        var textBeforeCursor = textArea.value.substring(0, cursor).split('\\n');\n\n        if (textBeforeCursor.length >= 0) {\n          cursor = 0;\n        }\n\n        textArea.setSelectionRange(cursor, cursor);\n        break;\n      }\n\n    case 'ArrowDown':\n      {\n        cursor = textArea.selectionEnd;\n        var textAfterCursor = textArea.value.substring(textArea.selectionEnd).split('\\n');\n\n        if (textAfterCursor.length >= 0) {\n          cursor += 500;\n        }\n\n        textArea.setSelectionRange(cursor, cursor);\n        break;\n      }\n\n    default:\n      text = '-1';\n      break;\n  }\n\n  if (code === 'AltLeft' && (e.shiftKey || keyboard.pressShift) || code === 'AltRight' && (e.shiftKey || keyboard.pressShift) || code === 'ShiftLeft' && e.altKey || code === 'ShiftRight' && e.altKey) {\n    keyboard.language();\n  }\n\n  if (!btn.dataset.shiftKey) {\n    text = btn.textContent;\n  }\n\n  if (!(code === 'CapsLock' || code === 'ShiftLeft' || code === 'ShiftRight')) {\n    btn.classList.add('active');\n    setTimeout(function () {\n      btn.classList.remove('active');\n    }, 300);\n  }\n\n  if (text) {\n    var beforeCursor = textArea.value.substring(0, cursor);\n    var afterCursor = textArea.value.substring(textArea.selectionEnd);\n    console.log(text);\n\n    if (text === '-1') {\n      text = '';\n    } else {\n      textArea.value = beforeCursor + text + afterCursor;\n      textArea.setSelectionRange(cursor + 1, cursor + 1);\n    }\n\n    if (text === '    ') textArea.setSelectionRange(cursor + 4, cursor + 4);\n  }\n};\n\n//# sourceURL=webpack:///./index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": function() { return /* binding */ Keyboard; }\n/* harmony export */ });\n/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./elements */ \"./js/elements.js\");\n/* harmony import */ var _createDOM__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createDOM */ \"./js/createDOM.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, \"prototype\", { writable: false }); return Constructor; }\n\n\n\n\nvar Keyboard = /*#__PURE__*/function () {\n  function Keyboard() {\n    _classCallCheck(this, Keyboard);\n\n    this.lang = 'en';\n    this.caps = 'offSet';\n    this.pressShift = false;\n    this.shiftKey = false;\n  }\n\n  _createClass(Keyboard, [{\n    key: \"createKeyboard\",\n    value: function createKeyboard() {\n      var _this = this;\n\n      this.languageFromLocStorage();\n      var keyboard = (0,_createDOM__WEBPACK_IMPORTED_MODULE_1__.createDom)('div', '', 'main__keyboard');\n      var container = (0,_createDOM__WEBPACK_IMPORTED_MODULE_1__.createDom)('div', '', 'keyboard-container');\n\n      var _loop = function _loop(i) {\n        var line = (0,_createDOM__WEBPACK_IMPORTED_MODULE_1__.createDom)('div', '', 'keyboard-line');\n        _elements__WEBPACK_IMPORTED_MODULE_0__.elements[i].forEach(function (e) {\n          var keyLang = e.key.ru && e.key.en ? e.key[_this.lang] : e.key;\n          var key = (0,_createDOM__WEBPACK_IMPORTED_MODULE_1__.createDom)('div', keyLang, 'keyboard-key'); //add current code for digital on dom \n\n          key.dataset.code = e.code; //check if the key has properties in Russian and English\n\n          if (e.key.ru && e.key.en) {\n            key.dataset.en = e.key.en;\n            key.dataset.ru = e.key.ru;\n          } //check if the key has a property to change by shift\n\n\n          if (e.shiftKey) {\n            key.dataset.ruShift = e.pressShift.ru;\n            key.dataset.enShift = e.pressShift.en;\n          } else {\n            key.dataset.shiftKey = false;\n          } // add all classes for each element from elements.js\n\n\n          if (e.class) key.classList.add(e.class);\n          line.append(key);\n        });\n        container.append(line);\n      };\n\n      for (var i = 0; i < _elements__WEBPACK_IMPORTED_MODULE_0__.elements.length; i++) {\n        _loop(i);\n      }\n\n      keyboard.append(container);\n      return keyboard;\n    }\n  }, {\n    key: \"language\",\n    value: function language() {\n      this.lang = this.lang === 'en' ? 'ru' : 'en';\n      localStorage.setItem('lang', this.lang);\n    }\n  }, {\n    key: \"languageFromLocStorage\",\n    value: function languageFromLocStorage() {\n      if (!localStorage.getItem('lang')) {\n        // console.log(localStorage)\n        localStorage.setItem('lang', this.lang);\n      } else {\n        this.lang = localStorage.getItem('lang');\n      }\n    }\n  }, {\n    key: \"capsLockPress\",\n    value: function capsLockPress(e) {\n      var btn = e.target;\n\n      if (this.caps === 'onSet') {\n        this.caps = 'offSet';\n        btn.classList.remove('active'); // console.log(btn)\n      } else {\n        this.caps = 'onSet';\n        btn.classList.add('active');\n      } // caseKeyboard(e);\n\n\n      this.caseKeyboard(e);\n    }\n  }, {\n    key: \"caseKeyboard\",\n    value: function caseKeyboard(ev) {\n      var _this2 = this;\n\n      var lang = this.lang;\n\n      if (ev.shiftKey || this.pressShift) {\n        document.querySelectorAll('.keyboard-key').forEach(function (e) {\n          if (e.dataset[\"\".concat(lang, \"Shift\")]) {\n            if (_this2.caps === 'onSet') {\n              e.innerHTML = e.dataset[\"\".concat(lang, \"Shift\")].toLowerCase();\n            } else e.innerHTML = e.dataset[\"\".concat(lang, \"Shift\")];\n          } else if (e.dataset[lang]) e.innerHTML = e.dataset[lang];\n        });\n      } else {\n        document.querySelectorAll('.keyboard-key').forEach(function (e) {\n          if (e.dataset[lang]) {\n            if (_this2.caps === 'onSet' && !(ev.shiftKey || _this2.pressShift)) {\n              e.innerHTML = e.dataset[lang].toUpperCase();\n            } else e.innerHTML = e.dataset[lang];\n          }\n        });\n      }\n    }\n  }]);\n\n  return Keyboard;\n}();\n\n\n\n//# sourceURL=webpack:///./js/Keyboard.js?");
